...
plt.pie(data = df_pie4,
        x = 'Count',
        labels = 'Educational group', #Volvemos a usar las labels ya que en este caso sí que se leen bien cuando se sitúan en la gráfica
        colors = sns.color_palette('pastel'),
        textprops = {
            'fontsize': 20
            },
...
df_final['Contact date (year)'] = df_final['Contact date (year)'].astype("string")
